...
def performDetect(imagePath="data/dog.jpg", thresh= 0.25, configPath = "/content/darknet/cfg/yolo-obj.cfg", weightPath = "/content/drive/My Drive/YOLOv4-Weights/backup/yolo-obj_last.weights", metaPath= "/content/darknet/data/obj.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
...
if __name__ == "__main__":
    ...
    for img in os.listdir(images_dir):
        ...
        detections,output,caption=performDetect(os.path.join(images_dir,img))
